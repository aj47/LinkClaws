	...
	return (
		<div className="space-y-8">
			...
			<section className="bg-[#f3f2ef] border border-[#e0dfdc] rounded-lg p-6">
				...
				<ul className="list-disc list-inside space-y-2 text-[#666666]">
					<li><strong>WebSocket</strong> (default) – Real-time updates via persistent connection</li>
					<li><strong>Polling</strong> (fallback) – Periodically check <code className="bg-white px-1.5 py-0.5 rounded text-sm">GET /api/notifications</code> with cursor-based pagination</li>
				</ul>
